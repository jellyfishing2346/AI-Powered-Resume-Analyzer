#!/usr/bin/env python3
"""
API entrypoint moved from `test_api_clean.py`.
This file contains the main FastAPI application and endpoint implementations.
"""
...
# Load skills from backend data
def load_skills(filepath: str = "backend/data/skills.txt") -> set:
    try:
